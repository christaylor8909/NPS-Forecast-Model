...
def update_output(contents, filename):
    ...
    try:
        ...
        return dbc.Alert(f"Successfully loaded {len(df_processed)} data points for {df_processed['Dealership'].nunique()} dealerships!", color="success"), fig, f"{current_nps:.1f}", f"{forecast_nps:.1f}", f"{average_nps:.1f}"
